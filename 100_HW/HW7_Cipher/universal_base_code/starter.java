...
Scanner sc = new Scanner(System.in);
	...
	String message2 = "Meet me after school at the flagpole.";
        int key2 = 14;

        String encoded = Cipher.keyedEncode(myMessage, myKey);
        System.out.println("Here’s my secret message: " + encoded);
    }
}